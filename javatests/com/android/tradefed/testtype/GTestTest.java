...
public class GTestTest {
    ...
    public void testRun() throws DeviceNotAvailableException {
        ...
        final String findCmd = String.format("find -L %s -type f -perm /u=rx", nativeTestPath);
    ...
    public void testRunFilterAbiPath() throws DeviceNotAvailableException {
        ...
        final String findCmd =
                String.format(
                        "find -L %s -type f -perm /u=rx -not -path \"*/arm/*\" -not -path"
    ...
    public void testRun_moduleName() throws DeviceNotAvailableException {
        ...
        final String findCmd = String.format("find -L %s -type f -perm /u=rx", modulePath);
    ...
    private void doTestFilter(String filterString) throws DeviceNotAvailableException {
        ...
        String findCmd = String.format("find -L %s -type f -perm /u=rx", nativeTestPath);
