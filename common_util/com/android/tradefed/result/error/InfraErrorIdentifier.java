...
public enum InfraErrorIdentifier implements ErrorIdentifier {
    ...
    OXYGEN_DEVICE_LAUNCHER_FAILURE(505_012, FailureStatus.DEPENDENCY_ISSUE),
    OXYGEN_SERVER_SHUTTING_DOWN(505_013, FailureStatus.INFRA_FAILURE),
    OXYGEN_BAD_GATEWAY_ERROR(505_014, FailureStatus.INFRA_FAILURE),
    OXYGEN_REQUEST_TIMEOUT(505_015, FailureStatus.INFRA_FAILURE),
    OXYGEN_RESOURCE_EXHAUSTED(505_016, FailureStatus.INFRA_FAILURE),
